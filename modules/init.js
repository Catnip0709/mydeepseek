...
import { state, storageRecoveryState, acquirePageLock, refreshPageLock, releasePageLock, readPageLock, isPageLockStale, getPageInstanceId, detectStoragePersistenceRisk, canModifyPersistedData } from './state.js?v=8';
import { trackEvent } from './utils.js?v=8';
import {
...
import { register } from './core.js?v=8';
import { renderChat, cancelEdit, checkScrollButton, scrollToBottom, rebindChatButtons, updateInputCounter, clearPendingTextAttachment, updateComposerPrimaryButtonState, closeComposerActionMenu } from './chat.js?v=8';
import { renderTabs, invalidateTabCache } from './tabs.js?v=8';
import {
...
} from './settings.js?v=8';
import { bindTabEvents } from './tabs.js?v=8';
import { bindChatEvents } from './chat.js?v=8';
import { bindGroupChatEvents, closeCreateGroupPanel, openCreateGroupPanel, closeBgInfoPanel, updateBgInfoChip } from './groupchat.js?v=8';
import { bindCharacterEvents, closeCharacterPanel, openCharacterPanel, getCharacterColor, getCharacterById, createCharacterChatTab, openCharacterSelectPanel } from './character.js?v=8';
import { bindPromptEvents, closeOptimizePreviewPanel, closePromptPanel } from './prompts.js?v=8';
import { bindMarketEvents, closePromptMarketPanel, closeAiGeneratePanel } from './market.js?v=8';
import { bindSearchEvents, clearSearch } from './search.js?v=8';
import { migrateLegacySummariesOnInit, migrateLegacySummaryForTab } from './summary.js?v=8';
import { bindStoryArchiveEvents, closeStoryArchivePanel, openStoryArchivePanel, markStoryArchiveStale } from './archive.js?v=8';
import { bindFavoritesEvents, closeFavoritePreviewPanel, closeFavoritesPanel, openFavoritesPanel, renderFavoritesPanel } from './favorites.js?v=8';
import { bindHtmlModeEvents } from './htmlmode.js?v=8';
