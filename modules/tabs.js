...
import { state, clearTabSending, isTabSending, storageRecoveryState, canModifyPersistedData } from './state.js?v=8';
import { escapeHtml, editIconSvg, downloadIconSvg, cleanupIconSvg, formatBytes } from './utils.js?v=8';
import { saveTabs, saveFavorites, generateNewTabId, getTabDisplayName, updateStorageUsage, flushPendingSaveImmediately } from './storage.js?v=8';
import { showToast, openRenameTabPanel, openDownloadPanel, closeSidebar, showEmptyChatHint, hideEmptyChatHint, showConfirmModal, openCleanupChoicePanel } from './panels.js?v=8';
import { removeFavoritesForTab } from './favorites.js?v=8';
