...
import { saveFavorites, saveTabs, getTabDisplayName } from './storage.js?v=6';
import { closeSidebar, showToast } from './panels.js?v=6';
import { escapeHtml, generateFavoriteId } from './utils.js?v=6';
